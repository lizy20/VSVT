classdef parfor_wait_ui < handle
   ...
   methods
       function Obj = parfor_wait_ui(TotalMessage, varargin)
           ...
           addParameter(InParser,'Title','Computing ...',@ischar);
           ...
           Obj.Title = InParser.Results.Title;
           Obj.FileName = InParser.Results.FileName;
           Obj.ReportInterval = InParser.Results.ReportInterval;
           if Obj.Waitbar
               Obj.WaitbarHandle = waitbar(0, [Obj.Title, num2str(0), '%'], 'Resize', true);
           end
           switch Obj.FileName
               case 'screen'
               otherwise
